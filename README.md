...
The classification is based on a visual and quantitative analysis of the rotation curves (specifically the initial slope angle $\alpha$), identifying three primary dynamical classes that we propose correspond to different evolutionary stages:
